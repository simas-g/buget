...
export default ({ children, variant, className, ...props }) => {
  ...
  const variants = {
    accent: theme === "dark" 
      ? "border-[#EB2563] border text-[#EB2563] hover:bg-[#EB2563] hover:text-white transition-colors duration-150"
      : "border-[#EB2563] border text-[#EB2563] hover:bg-[#EB2563] hover:text-white transition-colors duration-150",
    ctaPrimary: theme === "dark"
      ? "bg-[#2563EB] text-white rounded-lg"
      : "bg-[#2563EB] text-white rounded-lg shadow-sm",
    primaryGradient: theme === "dark"
      ? "bg-gradient-to-r from-[#2563EB] to-[#EB2563] text-white hover:shadow-[0_0_20px_var(--color-secondary)] transition-all duration-150"
      : "bg-gradient-to-r from-[#2563EB] to-[#EB2563] text-white hover:shadow-lg transition-all duration-150",
    basic: theme === "dark"
      ? "text-white border hover:bg-white hover:text-gray-700 transition-all duration-150"
      : "text-gray-800 border border-gray-300 hover:bg-gray-100 hover:text-gray-900 transition-all duration-150",
    primary: theme === "dark"
